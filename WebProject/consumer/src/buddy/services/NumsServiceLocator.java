...
public class NumsServiceLocator extends org.apache.axis.client.Service implements buddy.services.NumsService {
    ...
    private java.lang.String Nums_address = "http://localhost:8080/Buddy/services/Nums";
    ...
    public buddy.services.Nums getNums(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            buddy.services.NumsSoapBindingStub _stub = new buddy.services.NumsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (buddy.services.Nums.class.isAssignableFrom(serviceEndpointInterface)) {
                buddy.services.NumsSoapBindingStub _stub = new buddy.services.NumsSoapBindingStub(new java.net.URL(Nums_address), this);
                _stub.setPortName(getNumsWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://services.buddy", "NumsService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://services.buddy", "Nums"));
        }
